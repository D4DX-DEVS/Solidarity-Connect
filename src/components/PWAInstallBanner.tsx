...
export function PWAInstallBanner() {
  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 sm:left-auto sm:w-80 z-50 bg-card border border-border rounded-xl shadow-lg p-4 flex items-center gap-3 animate-in slide-in-from-bottom-4">
